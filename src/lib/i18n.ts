...
const content: Record<Locale, SiteContent> = {
  pt: {
    ...
    chat: {
      ...
      sent: 'Pronto, recebido! O time da Diretriz responde em até 1 dia útil. Se tiver outra demanda, é só iniciar uma nova conversa.',
  ...
  en: {
    ...
    chat: {
      ...
      sent: 'All set, got it! The Diretriz team will reply within 1 business day. If you have another request, just start a new conversation.',
      retry: 'Try again',
      open: 'Open chat',
      close: 'Close chat',
      newChat: 'New chat',
